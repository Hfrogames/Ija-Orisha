...
namespace IjaOrisha.Cards.Script
{
    ...
    {
        public static BattleManagerOld Instance { get; private set; }
        public float FormationTimeout { get; private set; } = 10;

        [SerializeField] private SessionSocket sessionSocket;
        [FormerlySerializedAs("playerFormation")] [SerializeField] private FormationManager formationManager;
        [SerializeField] private PlayerLoader.PlayerLoader playerOneLoader;
        [SerializeField] private PlayerLoader.PlayerLoader playerTwoLoader;
